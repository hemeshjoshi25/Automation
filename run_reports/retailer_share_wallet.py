...
class RunRetailerShareWallet(IscE2eTestCase):
    """Run a Retailer Share of Wallet Report"""

    def setUp(self):
        """Set Up"""
        super(RunRetailerShareWallet, self).setUp()
    ...
    def test_c_category(self):
        self.select.search_hierarchy_select(Prompts.CATEGORY.value, RSOW.CAT.value,
                                            RSOW.CAT_LEV.value, RSOW.CAT_SEL.value)
