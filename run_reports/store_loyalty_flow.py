...
class RunStoreLoyaltyFlow(IscE2eTestCase):
    """Run a Store Loyalty Flow Report"""

    def setUp(self):
        """Set Up"""
        super(RunStoreLoyaltyFlow, self).setUp()
    ...
    def test_b_product(self):
        self.select.search_hierarchy(Prompts.PRODUCT.value, SLF.PROD.value, SLF.PROD_LEV.value)
