...
class RunBasketAffinity(IscE2eTestCase):
    """Run a Basket Affinity Report"""

    def setUp(self):
        """Set Up"""
        super(RunBasketAffinity, self).setUp()
    ...
    def test_b_product(self):
        self.select.search_hierarchy(Prompts.PRODUCT.value, BA.PROD.value, BA.PROD_LEV.value)

    def test_c_category(self):
        self.select.search_hierarchy_select(Prompts.CATEGORY.value, BA.CAT.value, BA.CAT_LEV.value, BA.CAT_SEL.value)
