...
class RunStoreDiagnostics(IscE2eTestCase):
    """Run a Store Diagnostics Report"""

    def setUp(self):
        """Set Up"""
        super(RunStoreDiagnostics, self).setUp()
    ...
    def test_b_product(self):
        self.select.search_hierarchy(Prompts.PRODUCT.value, SD.PROD.value, SD.PROD_LEV.value)
