...
class RunPeopleScorecard(IscE2eTestCase):
    """Run a People Scorecard Report"""

    def setUp(self):
        """Set Up"""
        super(RunPeopleScorecard, self).setUp()
    ...
    def test_b_category(self):
        self.select.search_hierarchy_select(Prompts.CATEGORY.value, PS.CAT.value, PS.CAT_LEV.value, PS.CAT_SEL.value)
