...
class RunLeakageTreeRV(IscE2eTestCase):
    """Run Leakage Tree Report in Retailer View"""

    def setUp(self):
        """Set Up"""
        super(RunLeakageTreeRV, self).setUp()
    ...
    def test_d_store(self):
        self.select.search_hierarchy(Prompts.STORE.value, LT.RV_STORE.value, LT.RV_STORE_LEV.value)
