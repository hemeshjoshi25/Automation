...
class RunShopperMetricsRV(IscE2eTestCase):
    """Run a Shopper Metrics Report in Retailer View"""

    def setUp(self):
        """Set Up"""
        super(RunShopperMetricsRV, self).setUp()
    ...
    def test_e_store(self):
        self.select.search_hierarchy(Prompts.STORE.value, SM.RV_STORE.value, SM.RV_STORE_LEV.value)
