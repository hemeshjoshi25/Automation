...
class RunNewItemSOVACG(IscE2eTestCase):
    """Run a New Item SOVA Report with Custom Groups"""

    def setUp(self):
        """Set Up"""
        super(RunNewItemSOVACG, self).setUp()
    ...
    def test_c_adv_category(self):
        ...
        self.select.search_hierarchy(Prompts.CATEGORY.value, NISOVA.CG_CAT.value, NISOVA.CG_CAT_LEV.value)
