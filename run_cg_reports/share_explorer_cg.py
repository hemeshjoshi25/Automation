...
class RunShareExplorerCG(IscE2eTestCase):
    """Run a Share Explorer Report with Custom Groups"""

    def setUp(self):
        """Set Up"""
        super(RunShareExplorerCG, self).setUp()
    ...
    def test_b_product(self):
        self.select.search_hierarchy(Prompts.PRODUCT.value, SE.CG_PROD.value, SE.CG_PROD_LEV.value)

    def test_c_category(self):
        self.select.search_hierarchy(Prompts.CATEGORY.value, SE.CG_CAT.value, SE.CG_CAT_LEV.value)
