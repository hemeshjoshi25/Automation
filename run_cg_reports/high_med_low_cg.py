...
class RunHighMedLowCG(IscE2eTestCase):
    """Run a High, Medium, Low Report"""

    def setUp(self):
        """Set Up"""
        super(RunHighMedLowCG, self).setUp()
    ...
    def test_b_product(self):
        self.select.search_hierarchy(Prompts.PRODUCT.value, HML.CG_PROD.value, HML.CG_PROD_LEV.value)

    def test_c_category(self):
        self.select.search_hierarchy(Prompts.CATEGORY.value, HML.CG_CAT.value, HML.CG_CAT_LEV.value)
