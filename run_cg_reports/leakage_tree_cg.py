...
class RunLeakageTreeCG(IscE2eTestCase):
    """Run a Leakage Tree Report with Custom Groups"""

    def setUp(self):
        """Set Up"""
        super(RunLeakageTreeCG, self).setUp()
    ...
    def test_b_product(self):
        self.select.search_hierarchy(Prompts.PRODUCT.value, LT.CG_PROD.value, LT.CG_PROD_LEV.value)

    def test_c_category(self):
        self.select.search_hierarchy(Prompts.CATEGORY.value, LT.CG_CAT.value, LT.CG_CAT_LEV.value)
