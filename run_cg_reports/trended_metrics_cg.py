...
class RunTrendedMetricsCG(IscE2eTestCase):
    """Run a Trended Metrics Report with Custom Groups"""

    def setUp(self):
        """Set Up"""
        super(RunTrendedMetricsCG, self).setUp()
    ...
    def test_b_category(self):
        self.select.search_hierarchy(Prompts.CATEGORY.value, TM.CG_CAT.value, TM.CG_CAT_LEV.value)
