...
class RunDataExplorerCG(IscE2eTestCase):
    """Run a Data Explorer Report with Custom Groups"""

    def setUp(self):
        """Set Up"""
        super(RunDataExplorerCG, self).setUp()
    ...
    def test_d_product(self):
        self.select.search_hierarchy(Prompts.PRODUCT.value, DE.CG_PROD.value, DE.CG_PROD_LEV.value)

    def test_e_category(self):
        self.select.search_hierarchy(Prompts.CATEGORY.value, DE.CG_CAT.value, DE.CG_CAT_LEV.value)
