...
class RunTripTypeProfileCG(IscE2eTestCase):
    """Run a Trip Type Profile with Custom Groups"""

    def setUp(self):
        """Set Up"""
        super(RunTripTypeProfileCG, self).setUp()
    ...
    def test_b_category(self):
        self.select.search_hierarchy(Prompts.CATEGORY.value, TTP.CG_CAT.value, TTP.CG_CAT_LEV.value)
